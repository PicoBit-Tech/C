...
int main(void) {
	...
	uint64_t varU64;
	int64_t  var64;
	printf("uint8_t :%lld Byte MIN:0 ... MAX:%u \n",sizeof(varU8),UINT8_MAX);
	printf("int8_t  :%lld Byte MIN:%d ... MAX:%d\n",sizeof(var8),INT8_MIN,INT8_MAX);
	printf("uint16_t:%lld Byte MIN:0 ... MAX:%u\n",sizeof(varU16),UINT16_MAX);
	printf("int16_t :%lld Byte MIN:%d ... MAX:%d\n",sizeof(var16),INT16_MIN,INT16_MAX);
	printf("uint32_t:%lld Byte MIN:0 ... MAX:%u\n",sizeof(varU32),UINT32_MAX);
	printf("int32_t :%lld Byte MIN:%d ... MAX:%d\n",sizeof(var32),INT32_MIN,INT32_MAX);
	printf("uint64_t:%lld Byte MIN:0 ... MAX:%llu\n",sizeof(varU64),UINT64_MAX);
	printf("int8_t  :%lld Byte MIN:%lld ... MAX:%lld\n",sizeof(var64),INT64_MIN,INT64_MAX);
